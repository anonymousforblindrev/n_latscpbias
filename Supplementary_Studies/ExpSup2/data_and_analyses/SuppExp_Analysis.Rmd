...
ggsave("results_means.svg",width=7,height=5)
ggsave("results_means.pdf",width=7,height=5)
```
...
ggsave("categories.svg",width=12,height=5)
ggsave("categories.pdf",width=12,height=5)
```
