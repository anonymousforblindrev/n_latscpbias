...
table(tdata_long$dv_query, tdata_long$outcome_valence)

tdata_long$dv_query <- factor(tdata_long$dv_query, levels = c("probability", "satisfaction"))

tdata_long$outcome_valence <- factor(tdata_long$outcome_valence, levels = c("negative", "positive"))
