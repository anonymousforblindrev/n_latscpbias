...
counts_spear <- subset(counts, Features == "Spear and net")

counts_feather <- subset(counts, Features == "Feathers and tooth")
...
counts_dontknow_spear <- subset(counts, Knowledge == "'you don't know'" & Features == "Spear and net")
counts_dontknow_feather <- subset(counts, Knowledge == "'you don't know'" & Features == "Feathers and tooth")

counts_noinf_spear <- subset(counts, Knowledge == "no information" & Features == "Spear and net")
counts_noinf_feather <- subset(counts, Knowledge == "no information" & Features == "Feathers and tooth")
