...
counts_spear <- subset(counts2, Features == "Spear and net")

counts_feather <- subset(counts2, Features == "Feathers and tooth")
...
Test if proportion of unbiased subjects is higher in feathe_tooth vs. spear_net
...
Features <- c("Spear and net", "Spear and net", "Feathers and tooth", "Feathers and tooth")
